<?php $__env->startSection('content'); ?>
    ...
    <main class="main minh-100vh">
        <!-- Section -->
        <section class="py-0"
                 style="background-image: url(<?php echo e(asset('/img/footer.png')); ?>); background-repeat: no-repeat; background-position: top right;">
            <div class="container">
                <div class="row position-relative">
                    <div class="col-lg-8 minh-100vh col-xl-7 bg-white pt-0 pt-lg-6 pb-6 pb-lg-3">
                        <div class="row align-items-center h-100">
                            <div class="col-lg-10 pb-3">
                                <h1 class="fs-3 fs-lg-5 title-underline mb-5 pb-3 anim-proxima-bold-black-46"><?php echo e(__('home.glance')); ?>

                                    <br><!--<span class="anim-proxima-bold-purple-46"><?php echo e(__('home.your')); ?></span>-->
                                    <span class="typed anim-proxima-bold-purple-46" data-typed-text="
                                <?php echo e(__('home.promo1')); ?>

                                <?php echo e(__('home.promo2')); ?>

                                <?php echo e(__('home.promo3')); ?>

                                <?php echo e(__('home.promo4')); ?>

                                <?php echo e(__('home.promo5')); ?>

                                <?php echo e(__('home.promo6')); ?>

                                <?php echo e(__('home.promo7')); ?>

                                " data-typed-loop="true" data-typed-id="typed_0"></span><span
                                        class="typed-cursor typed-cursor--blink"></span>
                                </h1>

                                <p class="mb-7 robot-regular-16-second-black"><?php echo e(__('home.2')); ?></p>

                                <div class="row justify-content-center justify-content-lg-start">
                                    <div class="col-8 col-lg-6">
                                        <a href="<?php echo e(url('/contact-us')); ?>"
                                           class="btn btn-primary btn-lg btn-block mb-2"><?php echo e(__('home.touch')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-xl-5 order-first order-lg-2 bg-secondary ext-r pt-lg-6">
                        <div
                            ...
                            <div class="owl-carousel"
                                ...
                                <div><img src="<?php echo e(asset('img/slider1.png')); ?>" class="img-fluid w-100" alt=""/></div>
                            </div>
                            <!-- End of Carousel -->
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 align-self-stretch py-6 py-lg-9">
                        <div class="bg-container overlay"
                             style="background-image: url(<?php echo e(asset('img/home3.jpg')); ?>);"></div>
                        <div class="position-relative">
                            <div class="px-sm-6 px-lg-8 px-xl-10">
                                <h3 class="my-0 text-uppercase robot-bold-20-blue"><?php echo e(__('home.what')); ?></h3>
                                <h2 class="mb-4 text-uppercase proxima-bold-white-26"><?php echo e(__('home.we')); ?></h2>
                                <p class="mb-0 robot-regular-16-white"><?php echo __('home.offer'); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 px-sm-8 px-ld-9 px-xl-12 pt-6 pb-4 py-lg-10 py-xl-8 align-self-stretch">
                        <h3 class="my-0 mb-4 proxima-bold-black-26 text-uppercase"><?php echo e(__('home.core')); ?></h3>
                        <ul class="list-unstyled mb-5">
                            <li class="mb-1"><span class="h6 robot-bold-16-blue mr-3">01</span><?php echo e(__('home.core1')); ?>

                            </li>
                            <li class="mb-1"><span class="h6 robot-bold-16-blue mr-3">02</span><?php echo e(__('home.core2')); ?>

                            </li>
                            <li class="mb-1"><span class="h6 robot-bold-16-blue mr-3">03</span><?php echo e(__('home.core3')); ?>

                            </li>
                            <li class="mb-1"><span class="h6 robot-bold-16-blue mr-3">04</span><?php echo e(__('home.core4')); ?>

                            </li>
                            <li class="mb-1"><span class="h6 robot-bold-16-blue mr-3">05</span><?php echo e(__('home.core5')); ?>
        ...
        <section class="pt-0">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h3 class="robot-bold-20-purple text-uppercase"><?php echo e(__('home.our')); ?></h3>
                        <h2 class="proxima-bold-black-26 text-uppercase"><?php echo e(__('home.projects')); ?></h2>
                    </div>
                </div>
                <div class="row">
                    <?php echo $__env->make('projects.current', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('projects.completed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </section>
        <!-- End of Section -->
        ...
        <section class="pt-7 pb-0 bg-blue-light">
            <div class="container">
                ...
                <div class="owl-carousel pb-6 px-lg-8 px-xl-12"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-lg-3">
                            <img src="<?php echo e(asset('img/profile-ana.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle"/>
                        </div>
                        <div class="col-lg-9">
                            <blockquote class="blockquote" data-aos="zoom-out-up">
                                <p class="robot-regular-16-black"><?php echo e(__('home.ana')); ?></p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-lg-3">
                            <img src="<?php echo e(asset('img/profile-09.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle"/>
                        </div>
                        <div class="col-lg-9">
                            <blockquote class="blockquote" data-aos="zoom-out-up">
                                <p class="robot-regular-16-black"><?php echo e(__('home.derek')); ?></p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-lg-3">
                            <img src="<?php echo e(asset('img/88.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle"/>
                        </div>
                        <div class="col-lg-9">
                            <blockquote class="blockquote" data-aos="zoom-out-up">
                                <p class="robot-regular-16-black"><?php echo e(__('home.joachim')); ?></p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-lg-3">
                            <img src="<?php echo e(asset('img/tobias.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle"/>
                        </div>
                        <div class="col-lg-9">
                            <blockquote class="blockquote" data-aos="zoom-out-up">
                                <p class="robot-regular-16-black"><?php echo e(__('home.tobias')); ?></p>
                ...
                <div class="row justify-content-center">
                    <div class="col-6 col-lg-3">
                        <img src="<?php echo e(asset('img/profile-10.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle" />
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row justify-content-center">
                    <div class="col-6 col-lg-3">
                        <img src="<?php echo e(asset('img/profile-11.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle" />
                    </div>
                    <div class="col-lg-9">
                        <blockquote class="blockquote">
                ...
                <div class="row justify-content-center">
                    <div class="col-6 col-lg-3">
                        <img src="<?php echo e(asset('img/profile-12.jpg')); ?>" alt="" class="img-fluid w-100 rounded-circle" />
                    </div>
                    <div class="col-lg-9">
                        <blockquote class="blockquote">
