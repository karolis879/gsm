            ...
            <div class="col d-flex flex-column mb-2 mt-3">
                <div class="row pt-5 pt-lg-8 pb-4 pb-lg-6 justify-content-center">
                    <div class="col-12 col-lg-3 text-center text-lg-left">
                        <div class="pb-4">
                            <h6 class="mb-1 mb-lg-4 raleway-semi-white-26 text-uppercase"><?php echo e(__('menu.contact')); ?></h6>
                    ...
                    <div class="col-12 col-lg-3 text-center text-lg-left">
                        ...
                        <ul class="pt-2 mb-5 fw-light list-unstyled">
                            <li class="my-1"><a href="/about-us" class="text-white"><?php echo e(__('menu.about')); ?></a></li>
                            <li class="my-1"><a href="/services" class="text-white"><?php echo e(__('menu.services')); ?></a></li>
                            <li class="my-1"><a href="/projects" class="text-white"><?php echo e(__('menu.projects')); ?></a></li>
                            <li class="my-1"><a href="/carrers" class="text-white"><?php echo e(__('menu.carrers')); ?></a></li>
                            <li class="my-1"><a href="/contact-us" class="text-white"><?php echo e(__('menu.contact')); ?></a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-lg-3 text-center text-lg-left">
                        <h6 class="mb-1 mb-lg-4 raleway-semi-white-26 text-uppercase">Information</h6>
                        <ul class="pt-2 mb-5 fw-light list-unstyled">
                            <li class="my-1"><a href="/terms-conditions" class="text-white"><?php echo __('terms.1'); ?></a>
                            </li>
